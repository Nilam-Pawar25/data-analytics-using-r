...
#Read the dataset
data <- read.csv("F:/SkillEdge/Analytics_R/data/heart-disease.csv",header=TRUE)
...
#In R, a categorical variable (a variable that takes on a finite amount of values) is a factor. 
#So we'll convert few of them to factors.
