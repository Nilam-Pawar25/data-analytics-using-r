...
#Hence,the no. of dummy var here will be 2-1 = 1.(i.e. Marital_status1 , remaining will go in third status)
...
insurance_premium1$Age_Grp1 <- ifelse(insurance_premium1$Age_Grp=='Generation X [37-52]yrs',1,0)
insurance_premium1$Age_Grp2 <- ifelse(insurance_premium1$Age_Grp=='Millennials [15-36]yrs',1,0)
