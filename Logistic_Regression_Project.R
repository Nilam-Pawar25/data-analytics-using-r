...
#getwd()
#Read the dataset----
data_adult<-read.csv("F:/SkillEdge/Analytics_R/data/annual_income.csv")
...
top_one_percent <- quantile(da1$hours.per.week, .99)
top_one_percent
...
#We observe that still 3 columns : workclass, race,gender are of char type
#so we will convert them into factor types:
